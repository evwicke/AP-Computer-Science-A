...
public class BombGUI {
    ...
    private VisualModule visualOverride;
    ...
    public BombGUI() {
        ...
        visualContainer = new JPanel(new FlowLayout(FlowLayout.CENTER, 20,20));
        visualContainer.setBackground(Color.BLACK);
        visualContainer.setPreferredSize(new Dimension(WINDOW_WIDTH, 320));
        ...
        visualOverride = new VisualModule("OVERRIDE", Color.RED);
        visualOverride.setVisible(false);
    ...
    public void showOverrideVisual() {
        visualOverride = new VisualModule("OVERRIDE", Color.RED);
        visualContainer.add(visualOverride);
    ...
    public void setOverrideVisual(String text, Color c) {
        visualOverride.updateState(text, c);
    }
